...
public class ControladorVistaEsquinaNoroeste {

    private final VistaMetodoEsquinaNoroeste v;
    private final Set<Long> celdasUsadas = new HashSet<>();

    public ControladorVistaEsquinaNoroeste(VistaMetodoEsquinaNoroeste vista) {
        this.v = vista;
